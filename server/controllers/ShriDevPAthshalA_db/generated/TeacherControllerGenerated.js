...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findBy_Classes/:key", authorize([]), TeacherController.findBy_Classes);
  ...
  */
  findBy_Classes: async (req, res) => {
    try {
      const result = await TeacherModel.findBy_Classes(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
